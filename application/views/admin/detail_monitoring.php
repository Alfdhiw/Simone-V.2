...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800" style="font-size: 40px;"><?= $title ?> <?= $monitor['divisi'] ?></h1>
    </div>
    <!-- Content Row -->
    <div class="row">
                        ...
                        <tbody>
                            <?php foreach ($detail as $dt) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-info" href="<?= base_url('dashboard/detailabsen/') . $dt['kode_magang'] ?>">Detail <i class="fas fa-search"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
