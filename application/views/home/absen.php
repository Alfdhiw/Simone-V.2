<div style="min-height: 100vh;" class="bg-light pt-md-5 pb-5">
    ...
    <div class="col-lg-6 col-md-8 col-12 m-auto">
        ...
        <div class="col-12 d-flex px-1 justify-content-between">
            <h3 class="section-title position-relative text-uppercase mx-xl-0 mb-4"><span class="pr-3" style="color: #444444; font-weight:500;"><span id="date_time"></span></span></h3>
        </div>
        <form action="<?= base_url('home/absen') ?>" method="post" enctype="multipart/form-data" class="mt-5">
            ...
            <div class=" form-row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input id="jobname" class="form-control shadow" type="text" name="jobname" value="<?= $peserta['jobname'] ?>" readonly />
                </div>
            ...
            <div class="form-group">
                ...
                <textarea id="kegiatan" class="form-control shadow " type="text" name="kegiatan" placeholder="Rincian Kegiatan Magang" rows="3"></textarea>
            </div>
