<div class="col-12 d-flex px-1 justify-content-between">
    <h1 class="section-title position-relative text-uppercase mx-xl-0 mb-1"><span class="pr-3" style="color: #444444; font-weight:500; font-size:30px;">Absensi Pulang Peserta Magang</span></h1>
</div>
<div class="col-12 d-flex px-1 justify-content-between">
...
<form action="<?= base_url('home/absenpulang') ?>" method="post" enctype="multipart/form-data" class="mt-5">
    ...
    <div class="form-group">
        ...
        <textarea id="kegiatan" class="form-control shadow " type="text" name="kegiatan" placeholder="Rincian Kegiatan Magang Hari Ini" rows="3"></textarea>
    </div>
