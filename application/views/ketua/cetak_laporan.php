            ...
            <table>
                ...
                <?php foreach ($datauser as $datauser) : ?>
                    <tr>
                        ...
                        <td class="desc"><b><?= $datauser['nim'] ?></b></td>
                        <td class="desc"><b><?= $datauser['nama'] ?></b></td>
                        ...
                        <td class="desc"><b><?= $datauser['email'] ?></b></td>
                        <td class="desc"><b><?= $datauser['password'] ?></b></td>
                        <td class="desc"><b><?= $datauser['divisi'] ?></b></td>
                        <td class="desc"><b><?php
