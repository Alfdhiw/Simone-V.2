        ...
        <div class="col-lg-12 col-md-12 col-12 m-auto">
            ...
            <div class="col-xl-12 col-md-12 mb-4">
                <form action="" method="post" enctype="multipart/form-data" class="mt-5">
                    ...
                    <input type="hidden" name="kode_ketua" value="<?php echo $profil['kode_ketua'] ?>" />
                    ...
                    <div class="form-group form-row mb-4">
                        ...
                        <div class="col-3">
                            ...
                            <div class="img">
                                <img class="border-right rounded-lg shadow img-thumbnail" name="foto" src="<?= base_url('assets/data/ketua/pas_foto/' . $profil['foto']); ?>" alt="" style="height: 200px; width: 170px">
                            </div>
                        </div>
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input id="telp" class="form-control shadow" type="text" name="telp" value="<?= $profil['telp'] ?>" required />
