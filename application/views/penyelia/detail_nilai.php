...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        if ($rownilai['sertifikat'] != null) {
            echo '<a href="' . base_url('penyelia/invoice/' . $kode_magang) . '" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>';
        } else {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Harap Isi Terlebih Dahulu Sertifikat !
                    </div>
