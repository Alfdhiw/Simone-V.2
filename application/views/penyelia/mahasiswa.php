                        ...
                        <div class="card-body p-0">
                            <table class="table table-hover table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><b><?php echo date('j F Y H:i:s', strtotime($info['tgl_daftar'])); ?></b></td>
                                </tr>
                                <tr>
                                    <td>Tanggal Diterima</td>
                                    <td><b><?php echo date('j F Y H:i:s', strtotime($info['tgl_terima'])); ?></b></td>
                                </tr>
                                <tr>
                                    <td>Nama</td>
                                    <td><b><?php echo $info['nama']; ?></b></td>
                                ...
                                <tr>
                                    <td>Telepon</td>
                                    <td><b><a href="https://wa.me/<?= $info['telepon'] ?>" target="_blank"><i class="fa-brands fa-whatsapp"></i> <?php echo $info['telepon']; ?></a></b></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Divisi Magang</td>
                                    <td>
                                        <div class="badge badge-secondary"><b style="font-size: 15px;"><?= $info['divisi'] ?></b></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Status Akun</td>
