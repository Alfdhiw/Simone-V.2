        ...
        <div class="modal fade" id="dataModal" tabindex="-1" aria-labelledby="dataModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('sekretaris/cetak_laporan') ?>" method="post" id="tes1">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center" style="text-transform:capitalize;"><a href="<?= base_url('sekretaris/detailpeserta/' . $d['kode_magang'])  ?>"><b><?= $d['nama']; ?></b> <i class="fa-solid fa-eye"></i></a></td>
                                        ...
                                        <td class="text-center" style="text-transform:capitalize;"><b><?= $d['divisi'] ?></b></td>
                                        <td class="text-center">
                                            <?php
                                            if ($d['is_active'] == 0) {
                                        ...
                                        <td class="text-center">
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-left">
                                                            <form action="<?= base_url('sekretaris/editdatamhs/') . $d['kode_magang']; ?>" method="POST">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="email_kampus" value="<?= $d['email_kampus'] ?>" disabled>
                                                                </div>
                                                                <div class="form-group">
                                            ...
                                            <span><a id="btn-hapus" type="button" href="<?= base_url('sekretaris/deletemhs/' . $d['kode_magang']) ?>" class="badge text-light bg-danger"><i class="fas fa-trash"></i> <span style="font-size:15px;">Hapus</span></a></span>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center" style="text-transform:capitalize;"><a href="<?= base_url('sekretaris/detailpeserta/' . $d['kode_magang'])  ?>"><b><?= $d['nama']; ?> <i class="fa-solid fa-eye"></i></b></a></td>
                                        <td class="text-center" style="text-transform:capitalize;"><b><?= $d['sekolah']; ?></b></td>
                                        <td class="text-center" style="text-transform:capitalize;"><b><?= $d['jurusan']; ?></b></td>
                                        <td class="text-center" style="text-transform:capitalize;"><b><?= $d['divisi']; ?></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <span><a id="btn-hapus" type="button" href="<?= base_url('sekretaris/deleteswa/' . $d['kode_magang']) ?>" class="badge text-light bg-danger"><i class="fas fa-trash"></i> <span style="font-size:15px;">Hapus</span></a></span>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
