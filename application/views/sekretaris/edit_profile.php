        ...
        <div class="col-lg-12 col-md-12 col-12 m-auto">
            ...
            <div class="col-xl-12 col-md-12 mb-4">
                <form action="" method="post" enctype="multipart/form-data" class="mt-5">
                    ...
                    <input type="hidden" name="kode_sekretaris" value="<?php echo $profil['kode_sekretaris'] ?>" />
                    ...
                    <div class="form-group form-row mb-4">
                        ...
                        <div class="col-3">
                            ...
                            <div class="img">
                                <img class="border-right rounded-lg shadow img-thumbnail" name="foto" src="<?= base_url('assets/data/sekretaris/pas_foto/' . $profil['foto']); ?>" alt="" style="height: 200px; width: 170px">
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="jeniskel" class="form-control shadow" type="text" name="jeniskel" required>
                                <option value="<?= $profil['jeniskel'] ?>"><?php if ($profil['jeniskel'] == '1') {
                                                                                echo 'Laki-laki';
                                                                            } else if ($profil['jeniskel'] == '2') {
                                                                                echo 'Perempuan';
                                                                            } else {
