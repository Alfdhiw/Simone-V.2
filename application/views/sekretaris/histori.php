                            ...
                            <tbody>
                                <?php foreach ($terima as $t) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('sekretaris/datapelamar/' . $t['kode_magang'])  ?>"><b><?= $t['nama']; ?> <i class="fa-solid fa-eye"></i></b></a></td>
                            ...
                            <tbody>
                                <?php foreach ($tolak as $tolak) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="<?= base_url('sekretaris/datapelamar/' . $tolak['kode_magang'])  ?>"><b><?= $tolak['nama']; ?> <i class="fa-solid fa-eye"></i></b></a></td>
                            ...
                            <tbody>
                                <?php foreach ($proses as $proses) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="<?= base_url('sekretaris/datapelamar/' . $proses['kode_magang'])  ?>"><b><?= $proses['nama']; ?> <i class="fa-solid fa-eye"></i></b></a></td>
                                        <td class="text-center"><b><?= $proses['sekolah']; ?></b></td>
                                        <td class="text-center"><b><?= $proses['divisi']; ?></b></td>
                                        <td class="text-center"><b><?= date('j F Y H:i:s', strtotime($proses['tgl_terima'])) ?></b></td>
                                        <td class="text-center"><?php
                                                                if ($proses['status'] == 0) {
                                                                    echo '<span class="badge text-light bg-secondary"><span style="font-size:15px;">Unverified</span></span>';
                                                                }
